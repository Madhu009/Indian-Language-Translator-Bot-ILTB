...
def clean_whitespace(chatbot, input_object):
    """
    ...
    input_object.text = input_object.text.replace('\n', ' ').replace('\r', ' ').replace('\t', ' ')

    # Remove any leeding or trailing whitespace
    input_object.text = input_object.text.strip()

    # Remove consecutive spaces
    input_object.text = re.sub(' +', ' ', input_object.text)
