...
from Util.utils import import_module
...
class LogicAdapter(Adapter):
    ...
    def __init__(self, **kwargs):
        ...
        from Logic.Tools.textcomparisons import levenshtein_distance
        from Logic.Tools.response_selection import get_first_response
