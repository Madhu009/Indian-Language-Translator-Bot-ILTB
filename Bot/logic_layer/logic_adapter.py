...
from logic_layer.Util.utils import import_module
...
class LogicAdapter(Adapter):
    ...
    def __init__(self, **kwargs):
        ...
        from logic_layer.Tools.textcomparisons import levenshtein_distance
        from logic_layer.Tools.response_selection import get_first_response
